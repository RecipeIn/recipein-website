    ...
    <>
      <section className="body-font font-nunito w-screen h-auto">
        ...
        <div className="content">
          <p className="text-center mt-16 text-[40px] h-[50px] font-extrabold text-font mb-4">Kontak</p>
          <div class="flex justify-center items-center h-screen">
            <div class="bg-primary shadow-lg rounded-lg p-6 mb-36">
              <img className="w-full mb-4" src={map} alt="Gambar"/>
              ...
              <div className="flex">
                ...
                <p className="text-font font-extrabold ml-40">+62831432XXXX</p>
