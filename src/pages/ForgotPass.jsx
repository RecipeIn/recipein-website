    ...
    return (
        ...
        <div className='grid grid-cols-2'>
                ...
                <div className='text-font ml-48 mt-4'>
                    <p className='text-[32px] font-extrabold pt-16'>Ganti Kata Sandi</p>
                    ...
                    <button type="submit" className="w-[400px] bg-primary font-bold rounded-[16px] text-[20px] mt-64 px-5 py-3 text-center">Kirim</button>
                </div>
