    ...
    <>
      <section className="body-font font-nunito w-screen h-full">
        ...
        <div className="flex mt-2 ml-8">
          ...
          <p className="text-[18px] text-font tracking-wider ml-1">4.2 (46) | 40 Ulasan </p>
        </div>
        <div className="flex mt-2 ml-8 mr-8">
          <p className="text-[18px] text-font tracking-wide">
            Salad buah ini sangat cocok untuk segala acara. Tidak pernah ada sisa! Ini adalah salah satu resep salad buah favorit saya, karena menurut saya saus jeruknya benar-benar cocok. Salad ini akan terasa lebih enak jika anda
            membiarkannya meresap lebih lama ke dalam sari buahnya. Saya lebih suka 3 hingga 4 jam di lemari es sebelum saya menyajikannya.
          </p>
        </div>
        <div className="inline-flex mt-2 ml-8">
          <p className="text-[18px] text-font tracking-wider">Resep oleh</p>
          <Link to="/viewprofile">
            <p className="text-[18px] text-primary tracking-wider ml-2">Dapur Amanda</p>
          </Link>
          ...
          <div className='bg-[#E6E6E6] w-[1300px] h-[100px] mt-4 mb-4 flex justify-center'>
            ...
            <div className="flex flex-col mt-6 ml-44 text-center">
              ...
              <div className="flex items-center justify-center w-54 h-6 mb-8">
                <IconButton icon={<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" className="" />} onClick={handleDecrease} />
                <span className=" text-lg text-secondary">{portion} Porsi</span>
                <IconButton icon={<path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" />} onClick={handleIncrease} />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 ml-12">
            ...
            <div className="text-font">
              ...
              <p className="text-[18px] font-medium tracking-wide w-[600px]">
                Untuk salad: Lapisi buah-buahan dalam mangkuk kaca bening besar dengan urutan sebagai berikut: nanas, stroberi, buah kiwi, pisang, jeruk, anggur, dan blueberry.
              </p>
        ...
        <div className="flex justify-between px-10">
          <div className="bg-primary w-[600px] h-[564px] rounded-[16px] mt-4 mb-12 p-3.5">
            <div className="bg-[#E6E6E6] w-[480px] h-[536px] rounded-[8px] p-4">
              ...
              <p className="text-[16px] tracking-wider text-[#B3B3B3]">
                <span className="text-[18px] font-bold text-font">Peringkat </span> (utama)
              </p>
              ...
              <p className="text-[16px] tracking-wider text-[#B3B3B3]">
                <span className="text-[18px] font-bold text-font">Ulasan Anda </span> (opsional)
              </p>
            ...
            <div className="">
              <div className="mt-4">
                ...
                <div className="mt-2 text-font text-[18px] tracking-wide w-[730px]">
                  <p>
                    Saya sangat merekomendasikan salad buah segar ini, terutama bagi mereka yang mencari camilan yang sehat dan memuaskan. Rasanya begitu alami dan penuh nutrisi, membuatnya menjadi pilihan yang sempurna untuk memulai hari
