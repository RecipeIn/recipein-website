                ...
                <div className='w-11/12 h-full bg-[#E6E6E6] rounded-[8px] mb-12 pb-10'>
                    ...
                    <div className='ml-12 mt-8 inline-flex text-font'>
                        <div className='flex flex-col'>
                            ...
                            <input type="text" id="rname" className="bg-white w-[595px] h-[50px] tracking-wider text-base border border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-6 py-3 text-font placeholder-[#B3B3B3]" placeholder="Contoh: Seblak Ceker" required></input>
                        </div>
                        <div className='flex flex-col ml-10'>
                            <label htmlFor="category" className="block text-[18px] font-bold justify-center pb-2 tracking-wider">Jenis/Kategori</label>
                            <input type="text"id="category" className="bg-white w-[595px] h-[50px] tracking-wider text-base border border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-6 py-3 text-font placeholder-[#B3B3B3]" placeholder="Contoh: Sarapan" required></input>
                        </div>
                        <div className='flex flex-col ml-10'>
                   ...
                   <div className='ml-12 mt-8 inline-flex text-font'>
                        <div className='flex flex-col'>
                            ...
                            <div className='inline-flex'>
                                <input type="text" id="timeprep" className="bg-white w-[220px] h-[50px] tracking-wider text-base border border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-6 py-3 text-font" placeholder="1" required></input>
                        ...
                        <div className='flex flex-col ml-8'>
                            ...
                            <div className='inline-flex'>
                                <input type="text" id="timecook" className="bg-white w-[220px] h-[50px] tracking-wider text-base border border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-6 py-3 text-font" placeholder="1" required></input>
                                <p className='text-[20px] mt-2 ml-2'>Menit</p>
                            </div>
                        </div>
                    ...
                    <div className='ml-12 -mt-12'>
                        ...
                        <textarea type="text" id="uname" className="bg-white w-[595px] h-[200px] tracking-wider text-base border resize-none border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-6 py-3 text-font" placeholder="Masukkan deskripsi" required></textarea>
                    </div>
                    ...
                    <div className='flex justify-between'>
                        <div>
                            <div className='flex flex-col ml-12'>
                                ...
                                <div className='inline-flex'>
                                    <input type="text" className="bg-white w-[373px] h-[50px] tracking-wider text-base border border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-6 py-3 text-font placeholder-[#B3B3B3]" placeholder="Bahan" required></input>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex flex-col ml-12'>
                            <div className='mb-4'>
                                ...
                                <textarea type="text" id="uname" className="bg-white w-[595px] h-[128px] tracking-wider text-base border resize-none border-black rounded-[10px] focus:ring-black-500 focus:border-black-500 block px-4 py-3 text-font" placeholder="Masukkan langkah" required></textarea>
                            </div>
                            <div className='mb-4'>
