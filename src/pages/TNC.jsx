        ...
        <div className="content">
          ...
          <div className="flex  ">
            <div className="w-1/2 mt-7 mb-32 ml-4 p-4">
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Penggunaan Layanan</p>
              ...
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Hak Kekayaan Intelektual</p>
              <p className="text-[23px] text-font ml-5 mb-5 ">
              ...
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Tanggung Jawab</p>
              <p className="text-[23px] text-font ml-5 mb-5 ">
              ...
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Hubungi Kami</p>
              <p className="text-[23px] text-font ml-5 mb-12 ">
                <span className="font-bold">Lebih Dekat: </span> Pertanyaan atau kekhawatiran? Kunjungi Hubungi kami.
              </p>
            </div>
            <div className="w-1/2 mt-7 p-4">
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Konten Pengguna</p>
              <p className="text-[23px] text-font ml-5 mb-5 ">
              ...
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Pembatalan dan Penghentian</p>
              <p className="text-[23px] text-font ml-5 mb-5 ">
              ...
              <p className="text-[33px] text-font ml-5 mb-5 font-extrabold ">Perubahan Syarat dan Ketentuan</p>
              <p className="text-[23px] text-font ml-5 mb-5 ">
