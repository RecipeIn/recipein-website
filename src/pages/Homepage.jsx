        ...
        <div className="">
          ...
          <ul className="absolute top-[510px] ml-12">
            <li className="bg-primary rounded-[4px] w-[178px] h-[45px] inline-flex justify-between border-none">
              <a href="/recipe" className="ml-4 mt-2 text-font text-[18px] font-bold hover:text-secondary">
                Jelajahi Resep
              </a>
          ...
          <div className="grid grid-cols-3 2xl:grid-cols-4 gap-y-8 ml-20">
            {weeklyMeals.map((weeklyMeals) => (
              <div className="rounded-[8px] border-2 border-[#B3B3B3] bg-white w-[323px] h-[400px] shadow-xl ">
                <Link to="/detail">
                  <img src={weeklyMeals.photo} className="rounded-[8px] w-[323px] h-[180px]" />
                </Link>
                <div className="ml-[268px] -mt-[176px] relative z-20">
                  <button className={`w-[44px] h-[44px] rounded-full cursor-pointer bg-primary items-center py-2.5 px-2.5 ${isLiked ? "text-red-500" : "text-font"}`} onClick={handleLikeClick}>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-3 2xl:grid-cols-4 gap-y-8 ml-20">
            {weeklyDrinks.map((weeklyDrinks) => (
              <div className="rounded-[8px] border-2 border-[#B3B3B3] bg-white w-[323px] h-[400px] shadow-xl ">
                <Link to="/detail">
                  <img src={weeklyDrinks.photo} className="rounded-[8px] w-[323px] h-[180px]" />
                </Link>
                <div className="ml-[268px] -mt-[176px] relative z-20">
                  <button className={`w-[44px] h-[44px] rounded-full cursor-pointer bg-primary items-center py-2.5 px-2.5 ${isLiked ? "text-red-500" : "text-font"}`} onClick={handleLikeClick}>
                    {isLiked ? <AiFillHeart fontSize="24px" /> : <AiOutlineHeart fontSize="24px" />}
                ...
                <Link to="/detail">
                  ...
                  <Link to="/viewprofile">
                    <p className="text-[#4D4D4D] text-[18px] font-light ml-5">Oleh {weeklyDrinks.creatorName}</p>
                  </Link>
                  <div className="inline-flex mt-[74px] ml-4">
                    <IoMdTime color="#AAAAAA" fontSize="24px" />
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-3 2xl:grid-cols-4 gap-y-8 ml-20">
            {newRecipe.map((newRecipe) => (
              <div className="rounded-[8px] border-2 border-[#B3B3B3] bg-white w-[323px] h-[400px] shadow-xl ">
                <Link to="/detail">
                  <img src={newRecipe.photo} className="rounded-[8px] w-[323px] h-[180px]" />
                </Link>
                <div className="ml-[268px] -mt-[176px] relative z-20">
                  <button className={`w-[44px] h-[44px] rounded-full cursor-pointer bg-primary items-center py-2.5 px-2.5 ${isLiked ? "text-red-500" : "text-font"}`} onClick={handleLikeClick}>
                    {isLiked ? <AiFillHeart fontSize="24px" /> : <AiOutlineHeart fontSize="24px" />}
