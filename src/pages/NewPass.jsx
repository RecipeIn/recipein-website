        ...
        <section className="body-font font-nunito w-screen h-auto">
            ...
            <div className='grid grid-cols-2'>
                ...
                <div className='text-font ml-48 mt-4'>
                    <p className='text-[32px] font-extrabold pt-12'>Buat Kata Sandi Baru</p>
                    ...
                    <button type="submit" className="w-[400px] bg-primary font-bold rounded-[16px] text-[20px] mt-36 px-5 py-3 text-center">Kirim</button>
                </div>
